...
export interface IVehicleClient {
    ...
    getById(vehicleId: string): Observable<VehicleDto>;
    update(vehicle: UpsertVehicleDto): Observable<VehicleDto>;
    create(vehhicle: UpsertVehicleDto): Observable<VehicleDto>;
...
export class VehicleClient implements IVehicleClient {
    ...
    constructor(@Inject(HttpClient) http: HttpClient, @Optional() @Inject(API_BASE_URL) baseUrl?: string) {
        this.http = http;
        this.baseUrl = baseUrl !== undefined && baseUrl !== null ? baseUrl : "http://localhost:5268";
    }
    ...
    getAllVehicle(): Observable<VehicleDto[]> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetAllVehicle(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAllVehicle(response_ as any);
                } catch (e) {
    ...
    protected processGetAllVehicle(response: HttpResponseBase): Observable<VehicleDto[]> {
    ...
    getById(vehicleId: string): Observable<VehicleDto> {
        let url_ = this.baseUrl + "/Vehicle/{vehicleId}";
    ...
    create(vehhicle: UpsertVehicleDto): Observable<VehicleDto> {
        ...
        const content_ = JSON.stringify(vehhicle);
    ...
    protected processCreate(response: HttpResponseBase): Observable<VehicleDto> {
        ...
        if (status === 200) {
            ...
            let result400: any = null;
            let resultData400 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result400 = VehicleDto.fromJS(resultData400);
            return throwException("A server side error occurred.", status, _responseText, _headers, result400);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
...
export class UpsertVehicleDto implements IUpsertVehicleDto {
    id!: string;
    name!: string;
    year!: number;
    cost!: number;

    constructor(data?: IUpsertVehicleDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): UpsertVehicleDto {
        data = typeof data === 'object' ? data : {};
        let result = new UpsertVehicleDto();
        result.init(data);
        return result;
    }
...
export interface IUpsertVehicleDto {
    id: string;
    name: string;
    year: number;
    cost: number;
